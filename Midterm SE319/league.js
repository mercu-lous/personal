...
function loadGame(myGames){
        ...
        let title = myGames.games[4].title;
        let year = myGames.games[4].year;
        let description = myGames.games[4].description;
        let lawsons_review = myGames.games[4].lawsons_review;
        let michaels_review = myGames.games[4].michaels_review;
        let img1 = myGames.games[4].url_1;
        let img2 = myGames.games[4].url_2;
        let img3 = myGames.games[4].url_3;
        ...
        div4.innerHTML = `
        <img src="${img2}" alt="league_2" style="height: 100%; width: 100%">
    <div class="container">
