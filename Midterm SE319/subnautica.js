...
function loadGame(myGames){
        ...
        let title = myGames.games[0].title;
        let year = myGames.games[0].year;
        let description = myGames.games[0].description;
        let lawsons_review = myGames.games[0].lawsons_review;
        let michaels_review = myGames.games[0].michaels_review;
        let img1 = myGames.games[0].url_1;
        let img2 = myGames.games[0].url_2;
        let img3 = myGames.games[0].url_3;
        ...
        div4.innerHTML = `
        <img src="${img3}" alt="subnautica_3" style="height: 100%; width: 100%">
    <div class="container">
