...
function loadGame(myGames){
        ...
        let title = myGames.games[1].title;
        let year = myGames.games[1].year;
        let description = myGames.games[1].description;
        let lawsons_review = myGames.games[1].lawsons_review;
        let michaels_review = myGames.games[1].michaels_review;
        let img1 = myGames.games[1].url_1;
        let img2 = myGames.games[1].url_2;
        let img3 = myGames.games[1].url_3;
