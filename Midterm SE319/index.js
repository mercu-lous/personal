...
function loadGame(myGames){
        ...
        let title = myGames.games[3].title;
        let year = myGames.games[3].year;
        let description = myGames.games[3].description;
        let lawsons_review = myGames.games[3].lawsons_review;
        let michaels_review = myGames.games[3].michaels_review;
        let img1 = myGames.games[3].url_1;
        let img2 = myGames.games[3].url_2;
        let img3 = myGames.games[3].url_3;
        ...
        div4.innerHTML = `
        <img src="${img1}" alt="subnautica_3" style="height: 100%; width: 100%">
    <div class="container">
      <div class="carousel-caption text-start">
        <h1>Valorant.</h1>
        <p class="opacity-75">Precise Tactical Shooter.</p>
        <p><a class="btn btn-lg btn-primary" href="https://playvalorant.com/en-us/">Sign up today</a></p>
      </div>
    </div>
        `;
