...
function loadGame(myGames){
        ...
        let title = myGames.games[5].title;
        let year = myGames.games[5].year;
        let description = myGames.games[5].description;
        let lawsons_review = myGames.games[5].lawsons_review;
        let michaels_review = myGames.games[5].michaels_review;
        let img1 = myGames.games[5].url_1;
        let img2 = myGames.games[5].url_2;
        let img3 = myGames.games[5].url_3;
        ...
        div4.innerHTML = `
        <img src="${img1}" alt="rs1" style="height: 100%; width: 100%">
    <div class="container">
      <div class="carousel-caption text-start">
        <h1>RuneScape.</h1>
        <p class="opacity-75">Fantasy MMORPG</p>
        <p><a class="btn btn-lg btn-primary" href="https://play.runescape.com/">Sign up today</a></p>
      </div>
    </div>
        `;
